        ...
        <div className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-50 ${sticky
            ...
            <div className="navbar">
                ...
                <div className="navbar-end space-x-3">
                    ...
                    {
                        Authuser ? <Logout /> : <div>
                            <a href="#" className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-900 duration-300 cursor-pointer" onClick={() => document.getElementById("my_modal_3").showModal()}>Login</a>
                            <Login />
                        </div>
                    }
                </div>
